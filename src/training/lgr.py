...
print(f'Logistic Regression Accuracy (Test): {test_score:.2f} or {test_score*100:.2f}%')
train_score = model.score(X_train, y_train)
print(f'Logistic Regression Accuracy (Train): {train_score:.2f} or {train_score*100:.2f}%')
